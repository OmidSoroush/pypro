...
urlpatterns = [
    ...
    path('sql/list/<slug>/', views.PostListView2.as_view(), name='post_list2'),
    path('sql/<int:pk>/', views.PostDetailView.as_view(), name='single-detail'),
    ...
    path('sql/drafts/', views.DraftListView.as_view(), name='post_draft_list'),
