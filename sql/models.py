...
class SQLPost(models.Model):
    author = models.ForeignKey(User, related_name='sqlposts', on_delete=models.CASCADE)
    ...
    def get_absolute_url(self):
        return reverse('sql:single-detail', kwargs={'pk': self.pk})
