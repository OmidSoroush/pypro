...
class DataEngineeringPost(models.Model):
    author = models.ForeignKey(User, related_name='dataEngineeringposts', on_delete=models.CASCADE)
    ...
    def get_absolute_url(self):
        return reverse('dataEngineering:single-detail', kwargs={'pk': self.pk})
