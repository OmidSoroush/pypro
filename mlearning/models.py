...
class MLPost(models.Model):
    author = models.ForeignKey(User, related_name='mlposts', on_delete=models.CASCADE)
    ...
    def get_absolute_url(self):
        return reverse('mlearning:single-detail', kwargs={'pk': self.pk})
