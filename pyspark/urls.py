...
urlpatterns = [
    ...
    path('pyspark/list/<slug>/', views.PostListView2.as_view(), name='post_list2'),
    path('pyspark/<int:pk>/', views.PostDetailView.as_view(), name='single-detail'),
    ...
    path('pyspark/drafts/', views.DraftListView.as_view(), name='post_draft_list'),
